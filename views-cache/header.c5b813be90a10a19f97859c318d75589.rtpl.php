<?php if(!class_exists('Rain\Tpl')){exit;}?><!-- Page Header -->
<!DOCTYPE html>
<!--
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="shopping-item">
                            <a href="/site/carrinho.html">Carrinho - <span class="cart-amunt">R$100</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
                        </div>
                    </div>
                </div>
            </div>
